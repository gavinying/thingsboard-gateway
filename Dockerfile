...
RUN python3 -m pip install --no-cache-dir --upgrade pip --user && python3 -m pip install --no-cache-dir --upgrade setuptools && python3 -m pip install --no-cache-dir importlib_metadata --user && python3 -m pip install --no-cache-dir tb-mqtt-client --user && python3 -m pip install --no-cache-dir -r requirements.txt
